...
HD_PWD='C:/Users/Mateusz/Desktop/studia/AiR/SR/MP_lab2_AND_cascade/MP_lab2_AND_cascade/MP_lab2_AND_cascade.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_chain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_chain.tcl
