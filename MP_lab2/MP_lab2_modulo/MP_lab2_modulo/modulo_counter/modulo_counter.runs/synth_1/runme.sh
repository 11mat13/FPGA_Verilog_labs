...
HD_PWD='C:/Users/Mateusz/Desktop/studia/AiR/SR/MP_lab2/MP_lab2_modulo/MP_lab2_modulo/modulo_counter/modulo_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulo_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulo_counter.tcl
