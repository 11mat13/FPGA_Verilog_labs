...
HD_PWD='C:/Users/Mateusz/Desktop/studia/AiR/SR/FPGA_Verilog_labs/MP_lab4/MP_lab4_add_mul/MP_lab4_add_mul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_mul.tcl
