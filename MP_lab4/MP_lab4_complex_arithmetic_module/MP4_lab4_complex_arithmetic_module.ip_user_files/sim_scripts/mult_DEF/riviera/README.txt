...
#
# Generated by export_simulation on Wed Apr 03 20:09:59 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './mult_DEF.sh' script.

./mult_DEF.sh -reset_run
...
./mult_DEF.sh -noclean_files

For more information on the script, please type './mult_DEF.sh -help'.
