...
#
# Generated by export_simulation on Wed Apr 03 21:56:39 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_add_ABCDEF.sh' script.

./c_add_ABCDEF.sh -reset_run
...
./c_add_ABCDEF.sh -noclean_files

For more information on the script, please type './c_add_ABCDEF.sh -help'.
