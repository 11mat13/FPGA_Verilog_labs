...
#
# Generated by export_simulation on Wed Apr 03 20:31:11 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_add_DE.sh' script.

./c_add_DE.sh -reset_run
...
./c_add_DE.sh -noclean_files

For more information on the script, please type './c_add_DE.sh -help'.
