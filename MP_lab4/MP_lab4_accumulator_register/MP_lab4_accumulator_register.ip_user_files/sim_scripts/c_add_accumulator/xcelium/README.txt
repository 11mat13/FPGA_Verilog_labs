...
#
# Generated by export_simulation on Tue Apr 09 19:39:12 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_add_accumulator.sh' script.

./c_add_accumulator.sh -reset_run
...
./c_add_accumulator.sh -noclean_files

For more information on the script, please type './c_add_accumulator.sh -help'.
