...
#
# Generated by Vivado on Tue Apr 09 18:53:49 +0200 2024
...
# Script info
echo -e "c_addsub_0.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_6 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot c_addsub_0 xil_defaultlib.c_addsub_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  c_addsub_0 -key {Behavioral:sim_1:Functional:c_addsub_0} -tclbatch cmd.tcl -log simulate.log
}
