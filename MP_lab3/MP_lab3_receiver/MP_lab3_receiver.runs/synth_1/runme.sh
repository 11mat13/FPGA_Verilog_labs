...
HD_PWD='C:/Users/Mateusz/Desktop/studia/AiR/SR/MP_lab3/MP_lab3_receiver/MP_lab3_receiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_machine_receiver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state_machine_receiver.tcl
