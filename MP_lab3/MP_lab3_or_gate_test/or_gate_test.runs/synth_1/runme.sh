...
HD_PWD='C:/Users/Mateusz/Desktop/studia/AiR/SR/MP_lab3/or_gate_test/or_gate_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or_gate.tcl
